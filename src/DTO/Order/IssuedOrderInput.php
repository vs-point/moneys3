...
/**
 * Strictly typed input for creating an issued order (objednávka vystavená).
 *
 * @see \VsPoint\MoneyS3\Agenda\IssuedOrderService
 */
final readonly class IssuedOrderInput implements InputObject
{
    /**
