...
/**
 * Strictly typed input for creating a warehouse received slip (skladová příjemka).
 *
 * @see \VsPoint\MoneyS3\Agenda\ReceivedSlipService
 */
final readonly class ReceivedSlipInput implements InputObject
{
    /**
